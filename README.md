...
固定评测集已扩展到 420 道教师问题：保留 100 道人工核心题，新增 274 道章节覆盖题（137 章、每章 2 题）、26 道跨教材题和 20 道域外拒答题。合计 380 道可回答题（其中 41 道跨教材题）和 40 道拒答题。在当前 7 本教材、137 章、6,498 个 chunk 上的可复现实测结果为：

| 指标 | 结果 |
|---|---:|
| 检索召回率@8 | 380/380，100% |
| 引用准确率@3 | 985/1,134，86.86% |
| 跨教材覆盖率@8 | 41/41，100% |
| 无答案拒答率 | 40/40，100% |
...
- [420 题 RAG 教师问题评测报告](./docs/evaluation/teacher-benchmark-v3.md)
- [版本记录](./CHANGELOG.md)
